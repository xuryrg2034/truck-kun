...
namespace Code.Infrastructure.Installers
{
    ...
    public class GameplaySceneInstaller : MonoInstaller
    {
        ...
        public override void InstallBindings()
        {
            ...
            Container.Bind<Vector3>().WithId("HeroSpawnPosition").FromInstance(spawnPos);
        ...
        {
            if (_levelConfig.Vehicle == null)
                Debug.LogError("[GameplaySceneInstaller] LevelConfig.Vehicle is null! " +
                    "Create via: Create > Truck-kun > Vehicle Config");
        ...
        private void BindLevelConfig()
        {
            ...
            // Bind VehicleConfig (required)
            if (_levelConfig.Vehicle != null)
                Container.BindInstance(_levelConfig.Vehicle).AsSingle();
        ...
        /// <summary>
        /// Bind runtime settings for non-vehicle systems.
        /// </summary>
