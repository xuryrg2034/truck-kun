...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Physics.RigidbodyComponent rigidbody { get { return (Code.Gameplay.Features.Physics.RigidbodyComponent)GetComponent(GameComponentsLookup.Rigidbody); } }
    ...
    public GameEntity AddRigidbody(UnityEngine.Rigidbody newValue) {
        ...
        var component = (Code.Gameplay.Features.Physics.RigidbodyComponent)CreateComponent(index, typeof(Code.Gameplay.Features.Physics.RigidbodyComponent));
