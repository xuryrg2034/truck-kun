...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Movement.MoveSpeed moveSpeed { get { return (Code.Gameplay.Features.Movement.MoveSpeed)GetComponent(GameComponentsLookup.MoveSpeed); } }
    ...
    public GameEntity AddMoveSpeed(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Movement.MoveSpeed)CreateComponent(index, typeof(Code.Gameplay.Features.Movement.MoveSpeed));
